...
WALKS_LIST_F = sys.argv[4]

# Iterate through nodes in node_dict
def main():
    ...
    for start_node in node_dict.keys():
        ...
        walks = take_walk(node_dict, walks_dict_wOrientation, start_node, walks_list_noOrientation)
...
def take_walk(node_dict, walks_dict_wOrientation, start_node, walks_list_noOrientation):
    node_counter = 0
